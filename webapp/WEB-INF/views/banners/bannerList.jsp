...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<a href="/cinemaApp/banner/create" class="btn btn-success" role="button" title="Nuevo Banner">Nuevo</a><br>
		<br>
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach items="${banners}" var="banner">
					<tr>
						...
						<td>${banner.titulo}</td>
						<td>${banner.fecha}</td>
						<td><img src="/cinemaApp/resources/images/${banner.archivo}" width="200px" alt="" /></td>
						<c:choose>
