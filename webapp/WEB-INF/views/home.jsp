					...
					<c:choose>
						<c:when test="${loop.index==0}">
							<div class="item active">
								<img src="${urlResources}/images/${banner.archivo}"
					...
					<div class="form-group">
						<label for="fecha">Fecha: </label> <select id="fecha" name="fecha"
							...
							<c:forEach var="fecha" items="${fechas}">
								<c:choose>
									<c:when test="${fechaSeleccionada == fecha}">
		...
		<div class="container marketing">
			...
			<div class="row">
				...
				<c:choose>
					...
					<c:when test="${fn:length(peliculas) gt 0}">
						<c:forEach var="pelicula" items="${peliculas}">

							<div class="col-xs-12 col-sm-6 col-md-3">
								<img class="img-rounded"
									src="${urlResources}/images/${pelicula.imagen}"
									alt="${pelicula.titulo}" width="150" height="200">
								...
								<p>
									<a class="btn btn-sm btn-primary"
										href="detalle?id=${pelicula.id}&fecha=${pelicula.fechaEstreno}"
					...
					<c:otherwise>
						<div class="alert alert-warning" role="alert">No se han
							encontrado peliculas en cartelera</div>
					</c:otherwise>
